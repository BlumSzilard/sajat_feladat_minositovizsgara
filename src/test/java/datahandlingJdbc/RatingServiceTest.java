...
import datahandlingJdbc.RatingRepository;
import datahandlingJdbc.RatingService;
...
class RatingServiceTest {
    datahandlingJdbc.RatingRepository ratingRepository;
    datahandlingJdbc.RatingService ratingService;
    @BeforeEach
    void init() {
        MariaDbDataSource dataSource = new MariaDbDataSource();
        try {
            dataSource.setUrl("jdbc:mariadb://localhost:3306/labs?useUnicode=true");
            dataSource.setUser("labs");
    ...
    void testSaveValidData_returnsPositveId() {
        Long id = ratingService.save(new datahandlingJdbc.Rating("Ede",9, 1, 5));
        Long id2 = ratingService.save(new datahandlingJdbc.Rating("Ede",10, 1, 5));
        assertTrue(id > 0);
        assertTrue(id2 > 0);
    }
    ...
    void testSaveInvalidDate_returnsNegativeId() {
        Long id = ratingService.save(new datahandlingJdbc.Rating("Ede",8, 1, 5));
        Long id2 = ratingService.save(new datahandlingJdbc.Rating("Ede",13, 1, 5));
        Long id3 = ratingService.save(new datahandlingJdbc.Rating("Ede",0, 2, 5));
    ...
    void testSaveInvalidTaskNr_returnsNegativeId() {
        Long id = ratingService.save(new datahandlingJdbc.Rating("Ede",9, 0, 5));
        Long id2 = ratingService.save(new datahandlingJdbc.Rating("Ede",10, -1, 5));
        Long id3 = ratingService.save(new datahandlingJdbc.Rating("Ede",11, 11, 5));
    ...
    void testSaveInvalidScore_returnsNegativeId() {
        Long id = ratingService.save(new datahandlingJdbc.Rating("Ede",9, 1, 11));
    ...
    void testGetMonthFullScore(){
        ratingService.save(new datahandlingJdbc.Rating("Ede", 10, 7, 4));
        ratingService.save(new datahandlingJdbc.Rating("Ede", 9, 1, 6));
        ratingService.save(new datahandlingJdbc.Rating("Ede", 9, 2, 4));
        ratingService.save(new datahandlingJdbc.Rating("Lajos", 9, 3, 3));
        ratingService.save(new datahandlingJdbc.Rating("Lajos", 9, 1, 5));
