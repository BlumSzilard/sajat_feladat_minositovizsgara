...
class RatingRepositoryTest {
    ...
    void testSave_IdNotNull() {
        Long id = ratingRepository.save(new datahandlingJdbc.Rating("Ede",1, 1, 5));
        assertNotNull(id);
    }
    ...
    void testSave_IdsAreNotSame() {
        Long id = ratingRepository.save(new datahandlingJdbc.Rating("Ede",1, 1, 5));
        Long id2 = ratingRepository.save(new datahandlingJdbc.Rating("Ede",1, 1, 5));
        assertNotNull(id);
        assertNotNull(id2);
    ...
    void testGetMonthFullScore(){
        ratingRepository.save(new datahandlingJdbc.Rating("Ede", 12, 7, 4));
        ratingRepository.save(new datahandlingJdbc.Rating("Ede", 1, 1, 6));
        ratingRepository.save(new datahandlingJdbc.Rating("Ede", 1, 2, 4));
        ratingRepository.save(new datahandlingJdbc.Rating("Lajos", 1, 3, 3));
        ratingRepository.save(new datahandlingJdbc.Rating("Lajos", 1, 1, 5));
